...
function getAllpatients() {
  authService
    .fetchWithToken("/med-center/api/patients")
    .then((response) => {
      if (!response.ok) {
...
function deletePatient(button) {
  ...
  function sendDeleteRequest(confirmation) {
    ...
    authService
      .fetchWithToken(`/med-center/api/patients/${patientId}?confirm=${confirmation}`, {
        method: "DELETE",
        headers: {
...
function showUpdatePatientModalW(button) {
  ...
  var updatepatientModal = new bootstrap.Modal(
    document.getElementById("updatepatientModal"),
  );
...
function createPatientRow(patient) {
  ...
  row
    ...
    .addEventListener("click", showUpdatePatientModalW);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  addButton.addEventListener("click", function () {
    ...
    var addpatientModal = new bootstrap.Modal(
